...
int main() {
    ...
    Technic technic1("Ivan Ivanov", "1234567890", Category(ApplianceCategory::Phone), 1000, 5);
    Technic technic2("Georgi Georgiev", "9876543210", Category(ApplianceCategory::Laptop), 1500, 8);
    ...
    BrokenAppliance brokenPhone(Category(ApplianceCategory::Phone), 200, false);
