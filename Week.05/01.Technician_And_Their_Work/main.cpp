...
int main() {
    ...
    BrokenAppliance brokenLaptop(ApplianceCategory::Laptop, 200, true);
    Client client1("Maria Petrova", brokenLaptop);
    ...
    technicForRepair.repairBrokenAppliance(brokenLaptop);
